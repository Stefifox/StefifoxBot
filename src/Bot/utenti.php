...
if(strpos($msg, "/iscritti")===0 and in_array($userID,array_flip($admins)))
{
...
if(strpos($msg, "/post")===0 and in_array($userID,array_flip($admins)))
{
...
if(strpos($msg, "/2post")===0 and in_array($userID,array_flip($admins)))
{
$campo = explode(" ", $msg);
...
if(strpos($msg, "/apostannulla")===0 and in_array($userID,array_flip($admins)))
{
...
if(strpos($msg, "/ban ")===0 and in_array($userID,array_flip($admins)))
{
$campo = explode(" ", $msg);
...
if(strpos($msg, "/unban ")===0 and in_array($userID,array_flip($admins)))
{
$campo = explode(" ", $msg);
